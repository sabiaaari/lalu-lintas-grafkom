...
class BaseModelColor:
    ...
    def get_model_matrix(self):
        m_model = glm.mat4()
        # 1. TRANSLASI ke posisi dunia (titik engsel)
        ...
        # 3. TRANSLASI PIVOT (Menggeser geometri agar ujungnya di titik engsel)
        m_model = glm.translate(m_model, self.pivot_offset)
